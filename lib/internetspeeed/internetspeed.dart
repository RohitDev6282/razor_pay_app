...
class InternetSpeedCheck extends StatefulWidget {
  const InternetSpeedCheck({ Key? key }) : super(key: key);

  @override
  _InternetSpeedCheckState createState() => _InternetSpeedCheckState();
}

class _InternetSpeedCheckState extends State<InternetSpeedCheck> {
